#
#  Be sure to run `pod spec lint DataViewable.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Ian MacCallum" => "iancmaccallum@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Ian MacCallum"
